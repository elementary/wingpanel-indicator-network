/* libnma-gtk4.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "NMA", gir_namespace = "NMA4", gir_version = "1.0", lower_case_cprefix = "nma_")]
namespace NMA {
	...
	public class BarCodeWidget : Gtk.Box, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {
		[CCode (has_construct_function = false)]
	...
	public class CertChooser : Gtk.Grid, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {
	...
	public class VpnPasswordDialog : Gtk.Dialog, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
	...
	public class WifiDialog : Gtk.Dialog, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
	...
	[CCode (cheader_filename = "nma-ui-utils.h", has_type_id = false)]
	[Compact]
	public class Ws {
